/**
 * ЧЕБУROOM (@cheburoom.zp) — Дані меню
 */
  ...
  items: [
    // ЧЕБУРЕКИ
    {
      ...
      options: {
        crust: [
          ...
          { name: "Янтик (суха пательня + фермерське масло)", priceDelta: 0 }
        ],
        extras: [
          { id: "extra-cheese", name: "Подвійний сир сулугуні", price: 30 },
          { id: "extra-jalapeno", name: "Гострий перець халапеньйо 🌶️", price: 20 },
    ...
    },
    {
      ...
      options: {
        crust: [
          { name: "Класичний фритюр (пухирці, хрускіт)", priceDelta: 0, default: true },
          { name: "Янтик (суха пательня + масло)", priceDelta: 0 }
        ],
        extras: [
          { id: "extra-cheese", name: "Подвійний сир сулугуні", price: 30 },
    ...
    },
    {
      ...
      options: {
        crust: [
          ...
          { name: "Янтик (суха пательня)", priceDelta: 0 }
        ],
        extras: [
    ...
    },
    {
      ...
      isSpicy: false,
      isVegetarian: true,
      image: "https://images.unsplash.com/photo-1523371067107-85ecb00d72ef?auto=format&fit=crop&w=800&q=80",
      customizable: false
    },
    {
      id: "drink-cola",
